...
const Navbar = (props) => {
  ...
  return (
    <>
      <nav className="sticky top-0 z-10 p-3 bg-white-900 dark:bg-gray-bg">
        <div className="flex items-center justify-between">
          <Link to="/">
            <div className="flex items-center justify-between">
              {/* <img
                className="w-auto ml-6 h-14"
                src={logo}
                draggable={false}
                alt="Your Company"
              /> */}
              <div className="ml-2 text-2xl font-bold text-blood">
                Blood Donation
              </div>
            </div>
          </Link>
          <div className="flex items-center justify-between">
            <>
              ...
              <button
                className="px-3 py-2 mx-2 rounded-full hover:shadow-lg"
                onClick={() => {
